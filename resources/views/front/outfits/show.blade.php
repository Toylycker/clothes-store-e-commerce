    ...
    <div class="container-xxl py-3">
        <div class="d-flex justify-content-between align-items-center border-bottom py-2 mb-3">
            ...
            @if (Auth::user()->seller != null and Auth::user()->seller->id == $outfitseller->seller->id or Auth::user()->role=='admin')
                <div>
                    <a href="{{ route('outfit.edit', [$outfitseller->outfit->id, $outfitseller->seller_id]) }}" class="btn btn-success btn-sm text-decoration-none">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form action="{{ route('outfit.delete', [$outfitseller->outfit->id, $outfitseller->seller_id]) }}" method="post">
                                        @csrf
                                        @method('DELETE')
        ...
        @if ($comments->count() > 0)
            <div class="mb-3 container-lg">
                ...
                <form action="{{route('comments.store', $outfitseller->id)}}" method="post">
                    @csrf
                        ...
                        <div class="col">
                            <div>
                                <div>
                                    ...
                                    <a href="{{ route('outfit.show', [$outfit->id, $item->seller_id]) }}" class="d-block link-dark small fw-bold my-1 line-clamp-2" style="height:2.5rem;">
                                        {{ $outfit->name() }}
                                    </a>
