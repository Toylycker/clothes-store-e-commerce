...
@section('content')
    <div class="container-xxl py-3">
        ...
        <div class="row justify-content-center">
            <form action="{{ route('outfit.store') }}" method="post" enctype="multipart/form-data" class="col-md-6 col-lg-4">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control @error('name_en') is-invalid @enderror" name="name_en" id="name_en" rows="3" maxlength="2550">
                    @error('name_en')
                        <div class="alert alert-danger mt-1">{{ $message }}</div>
                    @enderror
                </div>
